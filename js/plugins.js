...
{"name":"CustomizeMaxSaveFile","status":false,"description":"最大セーブファイル数変更プラグイン","parameters":{"セーブファイル数":"1"}},
{"name":"SaveFileDrawFace","status":false,"description":"セーブファイルのフェイス表示プラグイン","parameters":{"表示行数":"1","マップ名表示":"OFF","ゲームタイトル非表示":"ON"}},
